	...
	<header >
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><img src="https://theme.hstatic.net/1000401164/1000509982/14/logo.png?v=486" alt="IMG-LOGO"></a>
			</div>
		...
		<div class="menu-mobile">
			<ul class="topbar-mobile">
				<li>
					<div class="left-top-bar">
						Miễn phí vận chuyển nếu đơn hàng hơn 300.000đ
					</div>
				</li>
			...
			<ul class="main-menu-m">
				...
				<li>
					<a href="shoping-cart.html" class="label1 rs1" data-label1="hot">Bán chạy</a>
				</li>

				<li>
					<a href="about.html">Câu chuyện</a>
				</li>
				...
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="FE/images/item-cart-01.jpg" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="FE/images/item-cart-02.jpg" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="FE/images/item-cart-03.jpg" alt="IMG">
						</div>
